...
const POSTGRES_CONNECTION_RETRIES = +(process.env.POSTGRES_CONNECTION_RETRIES || 5)
const POSTGRES_CONNECTION_RETRY_DELAY = +(process.env.POSTGRES_CONNECTION_RETRY_DELAY || 2000)
...
module.exports = {
  ...
  POSTGRES_CONNECTION_RETRY_DELAY,
  AMQP_URL,
  AMQP_EXCHANGE,
  AMQP_QUEUE,
